    ...
    <div className="space-y-4 sm:space-y-6 relative">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-500 text-sm mt-1">Manage {filteredMembers.length} members from the live database.</p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 w-full md:w-auto">
          <div className="relative w-full sm:w-72">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-3 sm:py-2.5 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-brand-blue transition-all bg-white text-sm sm:text-base"
            />
          </div>
            ...
            <tbody className="divide-y divide-slate-100">
              {paginatedMembers.map((member) => (
                ...
                >
                  ...
                  <td className="px-4 sm:px-6 py-3 sm:py-4">
                    <div className="flex items-center gap-3">
                      {member.profile_photo_url ? (
                        ...
                        <div className={`w-9 h-9 sm:w-10 sm:h-10 rounded-full flex-shrink-0 flex items-center justify-center font-bold text-xs sm:text-sm ${
                  ...
                  {/* Streak Column */}
                  <td className="px-4 sm:px-6 py-3 sm:py-4 flex justify-end">
              ...
              {paginatedMembers.length === 0 && (
                <tr>
                  <td colSpan="5" className="px-4 sm:px-6 py-10 text-center text-slate-500">
      ...
      {selectedMember && (
        <div className="fixed inset-0 z-50 bg-slate-950/60 backdrop-blur-sm flex items-center justify-center p-3 sm:p-4 animate-in fade-in">
          ...
          <div className="bg-white w-full max-w-2xl max-h-[90vh] rounded-2xl sm:rounded-3xl shadow-2xl flex flex-col overflow-hidden animate-in zoom-in-95 duration-200">
            ...
            <div className="p-4 sm:p-6 md:p-8 overflow-y-auto">
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 items-center sm:items-start mb-6 sm:mb-8">
                <div className="w-24 h-24 sm:w-32 sm:h-32 rounded-full flex-shrink-0 bg-slate-100 border-4 border-white shadow-lg overflow-hidden flex items-center justify-center">
                ...
                <div className="text-center sm:text-left flex-1 w-full">
                  <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3 mb-2 justify-center sm:justify-start">
                    ...
                    <span className="capitalize text-[10px] sm:text-xs font-bold px-2.5 py-1 rounded-full bg-slate-100 text-slate-600 border border-slate-200 w-max mx-auto sm:mx-0">
                      {selectedMember.role}
                    </span>
                  </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                <div className="p-3 sm:p-4 rounded-xl sm:rounded-2xl border border-slate-100 bg-white shadow-sm flex gap-3">
                  ...
                  <div className="overflow-hidden">
                    ...
                    <p className="font-semibold text-slate-800 text-sm sm:text-base truncate">{selectedMember.phone_number}</p>
                  </div>
                </div>
                ...
                <div className="p-3 sm:p-4 rounded-xl sm:rounded-2xl border border-slate-100 bg-white shadow-sm flex gap-3">
                  ...
                  <div className="overflow-hidden">
                    ...
                    <p className="font-semibold text-slate-800 text-sm sm:text-base truncate">{selectedMember.sex || 'Not specified'}</p>
                  </div>
                </div>
                ...
                <div className="p-3 sm:p-4 rounded-xl sm:rounded-2xl border border-slate-100 bg-white shadow-sm flex gap-3">
                  ...
                  <div className="overflow-hidden">
                    ...
                    <p className="font-semibold text-slate-800 text-sm sm:text-base truncate">{selectedMember.cell_group_name}</p>
                  </div>
                </div>
                ...
                <div className="p-3 sm:p-4 rounded-xl sm:rounded-2xl border border-slate-100 bg-white shadow-sm flex gap-3">
                  ...
                  <div className="overflow-hidden">
                    ...
                    <p className="font-semibold text-slate-800 text-sm sm:text-base truncate">{selectedMember.location_zone || 'Not specified'}</p>
                  </div>
                </div>
              </div>
